<div>
    <div class="flex-wrap pb-4 d-flex justify-content-between flex-md-nowrap align-items-center">
        ...
        <x-layouts.breadscrumb heading="Accounts" sub-heading="Manage your cash and bank accounts." />

        <div class="mb-2 btn-toolbar mb-md-0">
            <a href="{{ route('account.create') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center"
                wire:navigate>
                ...
                @foreach ($accounts as $index => $account)
                    <tr wire:key="{{ $account->id }}">
                        ...
                        <td>
                            ...
                            <button class="btn btn-danger" wire:click="setDeleteId({{ $account->id }})"
