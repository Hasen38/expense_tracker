<div>
    <div class="flex-wrap pb-4 d-flex justify-content-between flex-md-nowrap align-items-center">
        ...
        <x-layouts.breadscrumb heading="Categories" sub-heading="Manage your income and expense categories." />
                ...
                @foreach ($categories as $index => $category)
                    <tr wire:key="{{ $category->id }}">
                        ...
                        <td>
                            ...
                            <button class="btn btn-danger" wire:click="setDeleteId({{ $category->id }})"
